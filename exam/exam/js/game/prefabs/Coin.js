var coin = function(game, x, y, key, frame) { //the same parameters as sprite does
    ...
    this.animations.add('spin'); //name this animation as 'spin', see preloader.js
    ...
    this.onOutOfBounSkill = true; //hide or kill the coin when it goes off screen
...
Coin.prototype.onKilled = function() {
    this.animations.frame = 0; //the coin will face the screen when its spin
};
